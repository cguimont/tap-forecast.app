...
class Transformer:
    ...
    def transform_recur(self, data, schema, path):
        ...
        for typ in types:
            #LOGGER.info("Types " + typ + ' '.join(map(str, path)))            
    ...
    def _transform_object(self, data, schema, path, pattern_properties):
        ...
        #     ["null", "object", "string"]
        #LOGGER.info("before isinstance")
        #print(data)
        #LOGGER.info("Path " + ' '.join(map(str, path)))        
        #LOGGER.info("Dict" + ' '.join(map(str, list(data))))
    ...
    def _transform(self, data, typ, schema, path):
        ...
        if typ == "null":
            ...
            #LOGGER.info("Objects do not necessarily" + ' '.join(map(str, path)))
